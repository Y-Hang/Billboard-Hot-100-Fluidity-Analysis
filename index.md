...
Specifically, if we roughly group the 62 years data by decade (actually by every 535 weeks) and count the *steady*s on Top 40 positions, we could get the following chart. It clearly illustrated that the chart saw more *Steady*s on its top part for the last 3 decades that it did for earlier decades. 
<iframe id="igraph" scrolling="no" style="border:none;" seamless="seamless" src="visuals/steady_songs_position_decennialy.html" height="500" width="1000"></iframe> 
