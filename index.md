...
The opposite of '*New*' is '*Steady*': the same old song on the same position for one more week, which is being stagnant in a hardcore way. Let see how many '*Steady*'s each year's chart had in Hot 100, Top 40 and Top 10. In the graph below, the three lines all soared in 1990s, when Billboard incorporated more accurate sales and radio data from SoundScan and BDS (Broadcast Data Systems). After that, the lines all seemed to plateaued out, especially for Top 40 and Top 10.  
...
Additionally, if we expand the definition of '*Steady*' from no position move to no greater than 1 position move (+1, 0, and -1. Excluding new songs.), we could see a more plateaued graph.  
