...
However, if we look at the same graph for Top 40 and Top 10, something interesting emerged. From previous investigation we learnt that more songs entered the Hot 100 and more songs debuted in Top 40 even Top 10, but below graph was telling us that the total number of songs made it to Top 40 and especially Top 10 every year actually stayed almost the same since 1990s. This gap explained the concurrence of high volumes in both '*New*'s and '*Steady*'s: only a relatively fixed number of songs could enter Top 40 and Top 10 regardless of how many '*New*' songs there were, so the Top 40 and Top 10 in 2000s and 2010s would just be as '*Steady*' as they were in 1990s even with more '*New*' songs and high debuts. With that being said, my guess in Part II that more high debuts would make the top part of chart more competitive turned out to be false. 
