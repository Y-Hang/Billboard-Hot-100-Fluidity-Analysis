...
The opposite of '*New*'' is '*Steady*': the same old song on the same position for one more week, which is being stagnant in a hardcore way. Let see how many 'Steady's each year's chart had. From below graph, we could tell that the for recent decades, the amount of '*Steady*'s was narrowly below the average. 
